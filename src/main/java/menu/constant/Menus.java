...
public enum Menus {
    ...
    public static final List<Menus> menusValues = List.of(일식, 한식, 중식, 아시안, 양식);

    private final List<String> menus;

    Menus(List<String> menus) {
        this.menus = menus;
    }

    public static Menus getMenusAt(int ordinal) {
        return menusValues.get(ordinal - 1);
    }
